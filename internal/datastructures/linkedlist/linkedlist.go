...
func (l *LinkedList[K]) getNode(index int) (bool, *node[K]) {
	// Out-of-bounds check
...
// false, -1 otherwise.
func (l *LinkedList[K]) Get(index int) (bool, K) {
...
func (l *LinkedList[K]) Append(data K) {
	element := node[K]{data: data}
	if l.size == 0 {
...
func (l *LinkedList[K]) Prepend(data K) {
	element := node[K]{data: data}
	if l.size == 0 {
...
func (l *LinkedList[K]) Insert(data K, index int) bool {
	element := node[K]{data: data}
...
func (l *LinkedList[K]) Remove(index int) bool {
